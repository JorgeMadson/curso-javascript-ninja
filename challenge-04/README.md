...
*/
carro.obterModel = function () { return carro.modelo };
...
if ( qnt <= carro.assentos && qnt <= carro.assentos - carro.quantidadePessoas ) {
...
*/
carro.obterCor(); //"ƒ String() { [native code] }"
...
//estava fazendo uns testes e mudei os valores dos atributos
carro.obterMarcaModelo(); // "Esse carro é um renô clio"
